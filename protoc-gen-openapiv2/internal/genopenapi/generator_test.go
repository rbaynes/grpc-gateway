...
import (
	...
	"github.com/rbaynes/grpc-gateway/v2/protoc-gen-openapiv2/internal/genopenapi"
	"gopkg.in/yaml.v3"
...
func TestGenerateYAML(t *testing.T) {
	...
	tests := []struct {
		...
		{
			// It tests https://github.com/rbaynes/grpc-gateway/issues/3557.
...
func TestGeneratedYAMLIndent(t *testing.T) {
	// It tests https://github.com/rbaynes/grpc-gateway/issues/2745.
	const in = `
